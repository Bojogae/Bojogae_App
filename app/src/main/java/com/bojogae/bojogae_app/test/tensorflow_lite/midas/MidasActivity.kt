...
class MidasActivity : AppCompatActivity() {

    private lateinit var previewView : PreviewView
    private lateinit var drawingOverlay: DrawingOverlay
    private lateinit var resultOverlay: DrawingOverlay
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_miadas)
        ...
        resultOverlay.setWillNotDraw(false)
        resultOverlay.setZOrderOnTop(true)

        val depthEstimationModel = MiDASModel( this )
        frameAnalyser = FrameAnalyser( depthEstimationModel , drawingOverlay, resultOverlay, this )
        ...
        flipCameraFAB.setOnClickListener {
            ...
            resultOverlay.isFrontCameraOn = !isFrontCameraOn
        ...
        depthMapDisplayFAB.setOnClickListener {
            ...
            resultOverlay.isShowingDepthMap = !isDepthMapDisplayed
